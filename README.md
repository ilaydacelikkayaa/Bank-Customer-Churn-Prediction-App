...
This project predicts whether a bank customer is likely to churn (leave the bank) based on demographic and financial information such as credit score, age, account balance, and activity status. It combines a machine learning model with a simple Streamlit web application for interactive use.
...
## Local Run Only
This project is intended to be run locally. The provided link `http://localhost:8501/` works only after running the app on your own machine.
